...
//! （`docs/planning/specs/nonlinear-api-design.md`参照、Issue #70はこのデータ構造定義のみが
//! スコープ。負の対数尤度・スコア・Hessian（`CostFunction`/`Gradient`/`Hessian`トレイト実装）は
//! 後続のIssueで追加する）。
//!
