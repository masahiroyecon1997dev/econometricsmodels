...
このファイルは `python_package/econometricsmodels/panel/` 配下のファイルを読み書きするときだけ自動ロードされる。詳細は`docs/spec/fe-spec.md` / `docs/spec/re-spec.md`（FE/RE共通の論点は`docs/planning/specs/panel-api-design.md`）が正本。
