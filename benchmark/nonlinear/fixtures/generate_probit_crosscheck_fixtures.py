"""Probitのクロスチェック用フィクスチャ（tests/api_tests/fixtures/benchmarks/
...
同じ欠落を実機確認済み。`run_statsmodels_benchmark.py`のdocstring参照。ユーザー確認済み）。
...
使用例:
    python generate_probit_crosscheck_fixtures.py \\
        --output ../../../tests/api_tests/fixtures/benchmarks/probit_crosscheck.json
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output",
        default="../../../tests/api_tests/fixtures/benchmarks/probit_crosscheck.json",
    )
